...
<!-- suchana/contact-us.html  22 Nov 2019 04:16:58 GMT -->
<head>
...
<body>
                ...
                <div class="col-md-4">
                    <div class="contact-about footer-margin">
                        ...
                        <div class="contact-location">
                            <ul>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i> Fortmouth Avenue 245349, New York</li>
                                <li><i class="fa fa-phone"></i> (012)-345-6789</li>                                        
                                <li><i class="fa fa-envelope"></i> info@suchana.com</li>
                            </ul>
                        </div>
                        <div class="follow_us">
    ...
    <!-- map jquery --><script src="js/map.js"></script>
...
<!-- suchana/contact-us.html  22 Nov 2019 04:16:59 GMT -->
</html>
